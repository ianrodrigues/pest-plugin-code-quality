...
> **Work in progress.** This package has no product behaviour yet. See `PRD.md` and `.tasks/` for the release plan; nothing here should be depended on until v0.1.0 ships.
