...
it('selects an exact class', function (): void {
    ...
    expect($chain)->toThrow(QualityExpectationFailed::class, implode("\n", [
        'IanRodrigues\CodeQuality\Tests\Fixtures\App\Http\Controllers\OrderController::cancel',
...
it('selects an array of targets', function (): void {
    ...
    expect($chain)->toThrow(QualityExpectationFailed::class, implode("\n", [
        'IanRodrigues\CodeQuality\Tests\Fixtures\App\BillingArchive\Old::reconcile',
...
it('selects enums', function (): void {
    ...
    expect($chain)->toThrow(QualityExpectationFailed::class, implode("\n", [
        'IanRodrigues\CodeQuality\Tests\Fixtures\App\Support\Status::label',
...
it('selects traits', function (): void {
    ...
    expect($chain)->toThrow(QualityExpectationFailed::class, implode("\n", [
        'IanRodrigues\CodeQuality\Tests\Fixtures\App\Support\Concerns\Sluggable::slug',
