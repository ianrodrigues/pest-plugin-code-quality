 ...
 *     coverage: array{filesFound: int, objects: int, withAst: int, methodsMeasured: int, skipped: list<array{path: string, reason: string}>},
...
function quality_entry(string $id, string $file, int $line, string $metric = 'ccn2'): array
{
    return [
        ...
        'directories' => ['app/Foo'],
        'exclusions' => [],
        'coverage' => ['filesFound' => 2, 'objects' => 2, 'withAst' => 2, 'methodsMeasured' => 2, 'skipped' => []],
        'baseline' => null,
        'measurements' => [
